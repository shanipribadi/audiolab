/* Generated by Cython 0.19.2 on Fri Nov 22 11:38:05 2013 */
...
#endif
#include <math.h>
#define __PYX_HAVE__macosx_backend
...
#define __Pyx_MODULE_NAME "macosx_backend"
int __pyx_module_is_main_macosx_backend = 0;
...
static int __pyx_pf_14macosx_backend_15CoreAudioDevice___init__(struct __pyx_obj_14macosx_backend_CoreAudioDevice *__pyx_v_self, Float64 __pyx_v_fs, int __pyx_v_nchannels); /* proto */
static PyObject *__pyx_pf_14macosx_backend_15CoreAudioDevice_2play(struct __pyx_obj_14macosx_backend_CoreAudioDevice *__pyx_v_self, PyArrayObject *__pyx_v_input); /* proto */
static int __pyx_pf_5numpy_7ndarray___getbuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info, int __pyx_v_flags); /* proto */
static void __pyx_pf_5numpy_7ndarray_2__releasebuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info); /* proto */
static PyObject *__pyx_tp_new_14macosx_backend_CoreAudioDevice(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
static char __pyx_k_1[] = "Error while getting default output properties.";
static char __pyx_k_3[] = "Error while getting stream format.";
static char __pyx_k_5[] = "Not linear pcm";
static char __pyx_k_7[] = "Error while setting stream format.";
static char __pyx_k_9[] = "Expect rank 2 array";
static char __pyx_k_11[] = "Only float64 supported for now";
static char __pyx_k_13[] = "CoreAudioDevice configured for %d channels, signal has %d channels";
static char __pyx_k_14[] = "error setting callback";
static char __pyx_k_16[] = "error starting ";
static char __pyx_k_18[] = "AudioDeviceStop failed";
static char __pyx_k_19[] = "AudioDeviceRemoveIO failed";
...
static OSStatus __pyx_f_14macosx_backend_class_callback(AudioDeviceID __pyx_v_device, AudioTimeStamp *__pyx_v_current_time, AudioBufferList *__pyx_v_data_in, AudioTimeStamp *__pyx_v_time_in, AudioBufferList *__pyx_v_data_out, AudioTimeStamp *__pyx_v_time_out, void *__pyx_v_client_data) {
  ...
  int __pyx_t_5;
  int __pyx_t_6;
  struct __pyx_t_14macosx_backend_CallbackData *__pyx_t_7;
  long __pyx_t_8;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("class_callback", 0);

  /* "macosx_backend.pyx":59
 *         AudioBufferList* data_out, AudioTimeStamp* time_out,
 *         void* client_data):
 *     cdef OSStatus st = 0             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = (((struct __pyx_t_14macosx_backend_CallbackData *)__pyx_v_client_data)[0]).idata;
  __pyx_v_data = __pyx_t_1;

  /* "macosx_backend.pyx":71
 * 
 *     data = (<CallbackData*>client_data)[0].idata
 *     nframes = (<CallbackData*>client_data)[0].nframes             # <<<<<<<<<<<<<<
 *     fake_stereo = (<CallbackData*>client_data)[0].fake_stereo
 * 
 */
  __pyx_t_2 = (((struct __pyx_t_14macosx_backend_CallbackData *)__pyx_v_client_data)[0]).nframes;
  __pyx_v_nframes = __pyx_t_2;

  /* "macosx_backend.pyx":72
 *     data = (<CallbackData*>client_data)[0].idata
 *     nframes = (<CallbackData*>client_data)[0].nframes
 *     fake_stereo = (<CallbackData*>client_data)[0].fake_stereo             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = (((struct __pyx_t_14macosx_backend_CallbackData *)__pyx_v_client_data)[0]).fake_stereo;
  __pyx_v_fake_stereo = __pyx_t_2;

  /* "macosx_backend.pyx":74
 *     fake_stereo = (<CallbackData*>client_data)[0].fake_stereo
 * 
 *     sz = (data_out[0].mBuffers)[0].mDataByteSize             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_3 = ((__pyx_v_data_out[0]).mBuffers[0]).mDataByteSize;
  __pyx_v_sz = __pyx_t_3;

  /* "macosx_backend.pyx":75
 * 
 *     sz = (data_out[0].mBuffers)[0].mDataByteSize
 *     obuffsz = sz / sizeof (float) ;             # <<<<<<<<<<<<<<
 *     obuffer = <float*>((data_out[0].mBuffers)[0].mData)
 ...
 */
  ...
  __pyx_v_obuffsz = (__pyx_v_sz / __pyx_t_4);

  /* "macosx_backend.pyx":76
 *     sz = (data_out[0].mBuffers)[0].mDataByteSize
 *     obuffsz = sz / sizeof (float) ;
 *     obuffer = <float*>((data_out[0].mBuffers)[0].mData)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_5 = ((__pyx_v_nframes < __pyx_v_obuffsz) != 0);
  if (__pyx_t_5) {

    /* "macosx_backend.pyx":79
 * 
 *     if nframes < obuffsz:
 *         wcount = nframes             # <<<<<<<<<<<<<<
 *         (<CallbackData*>client_data)[0].remaining = 0
 ...
 */
  __pyx_t_5 = (__pyx_v_fake_stereo != 0);
  if (__pyx_t_5) {

    /* "macosx_backend.pyx":85
 * 
 *     if fake_stereo:
 *         wcount /= 2             # <<<<<<<<<<<<<<
 *         for i in range(wcount):
 *             obuffer[2 * i] = data[i]
 */
    __pyx_v_wcount = __Pyx_div_long(__pyx_v_wcount, 2);

    /* "macosx_backend.pyx":86
 *     if fake_stereo:
 *         wcount /= 2
 *         for i in range(wcount):             # <<<<<<<<<<<<<<
 *             obuffer[2 * i] = data[i]
 ...
 *     else:
 */
    __pyx_t_2 = __pyx_v_obuffsz;
    for (__pyx_t_6 = (2 * __pyx_v_wcount); __pyx_t_6 < __pyx_t_2; __pyx_t_6+=1) {
      __pyx_v_i = __pyx_t_6;

      /* "macosx_backend.pyx":91
 *         # Fill with 0 if output buffer biffer than remaining data to be read
 *         for i in range(2 * wcount, obuffsz):
 *             obuffer[i] = 0.0             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    __pyx_t_2 = __pyx_v_obuffsz;
    for (__pyx_t_6 = __pyx_v_wcount; __pyx_t_6 < __pyx_t_2; __pyx_t_6+=1) {
      __pyx_v_i = __pyx_t_6;

      /* "macosx_backend.pyx":97
 *         # Fill with 0 if output buffer biffer than remaining data to be read
 *         for i in range(wcount, obuffsz):
 *             obuffer[i] = 0.0             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_t_7 = ((struct __pyx_t_14macosx_backend_CallbackData *)__pyx_v_client_data);
  __pyx_t_8 = 0;
  (__pyx_t_7[__pyx_t_8]).nframes = ((__pyx_t_7[__pyx_t_8]).nframes - __pyx_v_wcount);

  /* "macosx_backend.pyx":100
 * 
 *     (<CallbackData*>client_data)[0].nframes -= wcount
 *     (<CallbackData*>client_data)[0].idata += wcount             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_7 = ((struct __pyx_t_14macosx_backend_CallbackData *)__pyx_v_client_data);
  __pyx_t_8 = 0;
  (__pyx_t_7[__pyx_t_8]).idata = ((__pyx_t_7[__pyx_t_8]).idata + __pyx_v_wcount);

  /* "macosx_backend.pyx":102
 *     (<CallbackData*>client_data)[0].idata += wcount
 * 
 *     return st             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("macosx_backend.class_callback", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static int __pyx_pw_14macosx_backend_15CoreAudioDevice_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_14macosx_backend_15CoreAudioDevice_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  Float64 __pyx_v_fs;
  ...
  __Pyx_RefNannySetupContext("__init__ (wrapper)", 0);
  {
    ...
    if (values[0]) {
      __pyx_v_fs = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_fs == (Float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {

      /* "macosx_backend.pyx":111
 *     cdef int nchannels
 * 
 ...
 *         cdef OSStatus st
 */
      __pyx_v_fs = ((Float64)48000.0);
    }
    if (values[1]) {
      __pyx_v_nchannels = __Pyx_PyInt_AsInt(values[1]); if (unlikely((__pyx_v_nchannels == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("macosx_backend.CoreAudioDevice.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14macosx_backend_15CoreAudioDevice___init__(((struct __pyx_obj_14macosx_backend_CoreAudioDevice *)__pyx_v_self), __pyx_v_fs, __pyx_v_nchannels);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

static int __pyx_pf_14macosx_backend_15CoreAudioDevice___init__(struct __pyx_obj_14macosx_backend_CoreAudioDevice *__pyx_v_self, Float64 __pyx_v_fs, int __pyx_v_nchannels) {
  UInt32 __pyx_v_sz;
  OSStatus __pyx_v_st;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
 ...
 * 
 */
  __pyx_v_self->proc_set = 0;

  /* "macosx_backend.pyx":116
 * 
 *         self.proc_set = 0
 *         self.dev_started = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_self->dev_started = 0;

  /* "macosx_backend.pyx":118
 *         self.dev_started = 0
 * 
 *         self.callback = class_callback             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_st = AudioHardwareGetProperty(kAudioHardwarePropertyDefaultOutputDevice, (&__pyx_v_sz), (&__pyx_v_self->dev));

  /* "macosx_backend.pyx":124
 *         st = AudioHardwareGetProperty(kAudioHardwarePropertyDefaultOutputDevice, &sz,
 *                 &self.dev)
 *         if st:             # <<<<<<<<<<<<<<
 *             raise RuntimeError("Error while getting default output properties.")
 ...
 */
    __pyx_t_2 = PyObject_Call(__pyx_builtin_RuntimeError, ((PyObject *)__pyx_k_tuple_2), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 125; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_v_sz = (sizeof(__pyx_v_self->format));

  /* "macosx_backend.pyx":131
 *         st = AudioDeviceGetProperty(self.dev, 0, False,
 *                 kAudioDevicePropertyStreamFormat, &sz,
 *                 &self.format)             # <<<<<<<<<<<<<<
 *         if st:
 ...
 */
  __pyx_v_st = AudioDeviceGetProperty(__pyx_v_self->dev, 0, 0, kAudioDevicePropertyStreamFormat, (&__pyx_v_sz), (&__pyx_v_self->format));

  /* "macosx_backend.pyx":132
 *                 kAudioDevicePropertyStreamFormat, &sz,
 *                 &self.format)
 *         if st:             # <<<<<<<<<<<<<<
 *             raise RuntimeError("Error while getting stream format.")
 ...
 */
    __pyx_t_2 = PyObject_Call(__pyx_builtin_RuntimeError, ((PyObject *)__pyx_k_tuple_4), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  __pyx_v_self->format.mSampleRate = __pyx_v_fs;

  /* "macosx_backend.pyx":139
 * 
 *         # CoreAudio can't do mono ? Fake stereo in that case for now
 ...
 */
  __pyx_v_self->nchannels = __pyx_v_nchannels;

  /* "macosx_backend.pyx":140
 *         # CoreAudio can't do mono ? Fake stereo in that case for now
 *         self.nchannels = nchannels
 *         if nchannels == 1:             # <<<<<<<<<<<<<<
 *             self.format.mChannelsPerFrame = 2
 *         else:
 */
  __pyx_t_1 = ((__pyx_v_nchannels == 1) != 0);
  if (__pyx_t_1) {

    /* "macosx_backend.pyx":141
 *         self.nchannels = nchannels
 *         if nchannels == 1:
 *             self.format.mChannelsPerFrame = 2             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    __pyx_v_self->format.mChannelsPerFrame = 2;
    goto __pyx_L5;
  }
  /*else*/ {

    /* "macosx_backend.pyx":143
 *             self.format.mChannelsPerFrame = 2
 *         else:
 *             self.format.mChannelsPerFrame = nchannels             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_self->format.mChannelsPerFrame = __pyx_v_nchannels;
  }
  __pyx_L5:;

  /* "macosx_backend.pyx":146
 * 
 *         # XXX: how to make sure we have 32 bits native float here ?
 ...
 * 
 */
  __pyx_t_1 = ((__pyx_v_self->format.mFormatID != kAudioFormatLinearPCM) != 0);
  if (__pyx_t_1) {

    /* "macosx_backend.pyx":147
 *         # XXX: how to make sure we have 32 bits native float here ?
 *         if self.format.mFormatID != kAudioFormatLinearPCM:
 *             raise ValueError("Not linear pcm")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_st = AudioDeviceSetProperty(__pyx_v_self->dev, NULL, 0, 0, kAudioDevicePropertyStreamFormat, (sizeof(__pyx_v_self->format)), (&__pyx_v_self->format));

  /* "macosx_backend.pyx":152
 *                 kAudioDevicePropertyStreamFormat,
 *                 sizeof(self.format), &self.format)
 *         if st:             # <<<<<<<<<<<<<<
 *             raise RuntimeError("Error while setting stream format.")
 ...
 */
    __pyx_t_2 = PyObject_Call(__pyx_builtin_RuntimeError, ((PyObject *)__pyx_k_tuple_8), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 153; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
/* Python wrapper */
static PyObject *__pyx_pw_14macosx_backend_15CoreAudioDevice_3play(PyObject *__pyx_v_self, PyObject *__pyx_v_input); /*proto*/
static PyObject *__pyx_pw_14macosx_backend_15CoreAudioDevice_3play(PyObject *__pyx_v_self, PyObject *__pyx_v_input) {
  ...
  __pyx_r = __pyx_pf_14macosx_backend_15CoreAudioDevice_2play(((struct __pyx_obj_14macosx_backend_CoreAudioDevice *)__pyx_v_self), ((PyArrayObject *)__pyx_v_input));
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_14macosx_backend_15CoreAudioDevice_2play(struct __pyx_obj_14macosx_backend_CoreAudioDevice *__pyx_v_self, PyArrayObject *__pyx_v_input) {
  int __pyx_v_nc;
  PyArrayObject *__pyx_v_cinput = 0;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_cinput;
  __Pyx_Buffer __pyx_pybuffer_cinput;
  ...
  __pyx_pybuffer_cinput.pybuffer.buf = NULL;
  __pyx_pybuffer_cinput.refcount = 0;
  __pyx_pybuffernd_cinput.data = NULL;
  __pyx_pybuffernd_cinput.rcbuffer = &__pyx_pybuffer_cinput;

  /* "macosx_backend.pyx":159
 *         cdef cnp.ndarray[cnp.float32_t, ndim=2] cinput
 * 
 *         if not input.ndim == 2:             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_2 = PyObject_Call(__pyx_builtin_ValueError, ((PyObject *)__pyx_k_tuple_10), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 160; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_input), __pyx_n_s__dtype); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s__float64); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyObject_RichCompare(__pyx_t_2, __pyx_t_4, Py_EQ); __Pyx_XGOTREF(__pyx_t_3); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_1 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely(__pyx_t_1 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_5 = ((!__pyx_t_1) != 0);
  if (__pyx_t_5) {

    /* "macosx_backend.pyx":163
 * 
 *         if not input.dtype == np.float64:
 *             raise NotImplementedError("Only float64 supported for now")             # <<<<<<<<<<<<<<
 * 
 *         nc = input.shape[0]
 */
    __pyx_t_3 = PyObject_Call(__pyx_builtin_NotImplementedError, ((PyObject *)__pyx_k_tuple_12), NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  __pyx_t_5 = ((!((__pyx_v_nc == __pyx_v_self->nchannels) != 0)) != 0);
  if (__pyx_t_5) {

    /* "macosx_backend.pyx":170
 *                     "CoreAudioDevice configured for %d channels, "\
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s__channels); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 170; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = PyInt_FromLong(__pyx_v_nc); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 170; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    ...
    __pyx_t_3 = 0;
    __pyx_t_4 = 0;
    __pyx_t_4 = PyNumber_Remainder(((PyObject *)__pyx_kp_s_13), ((PyObject *)__pyx_t_2)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    __pyx_t_4 = 0;
    __pyx_t_4 = PyObject_Call(__pyx_builtin_ValueError, ((PyObject *)__pyx_t_2), NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 167; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(((PyObject *)__pyx_t_2)); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s__asfortranarray); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 172; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s__np); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 172; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s__float32); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 172; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_3);
  {
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_cinput.rcbuffer->pybuffer);
    __pyx_t_7 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_cinput.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
    if (unlikely(__pyx_t_7 < 0)) {
      PyErr_Fetch(&__pyx_t_8, &__pyx_t_9, &__pyx_t_10);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_cinput.rcbuffer->pybuffer, (PyObject*)__pyx_v_cinput, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
    ...
    __pyx_pybuffernd_cinput.diminfo[0].strides = __pyx_pybuffernd_cinput.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_cinput.diminfo[0].shape = __pyx_pybuffernd_cinput.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_cinput.diminfo[1].strides = __pyx_pybuffernd_cinput.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_cinput.diminfo[1].shape = __pyx_pybuffernd_cinput.rcbuffer->pybuffer.shape[1];
    if (unlikely(__pyx_t_7 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 172; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_6 = 0;
  __pyx_v_cinput = ((PyArrayObject *)__pyx_t_3);
  __pyx_t_3 = 0;

  /* "macosx_backend.pyx":173
 * 
 *         cinput = np.asfortranarray(input, np.float32)
 *         self._play(cinput)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_7 = ((struct __pyx_vtabstruct_14macosx_backend_CoreAudioDevice *)__pyx_v_self->__pyx_vtab)->_play(__pyx_v_self, ((PyArrayObject *)__pyx_v_cinput)); if (unlikely(__pyx_t_7 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 173; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __Pyx_AddTraceback("macosx_backend.CoreAudioDevice.play", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_cinput.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_cinput);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "macosx_backend.pyx":175
 *         self._play(cinput)
 * 
 *     cdef int _play(CoreAudioDevice self, cnp.ndarray input) except -1:             # <<<<<<<<<<<<<<
 *         cdef OSStatus st
 ...
 *             data.fake_stereo = 1
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_input), __pyx_n_s__size); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 182; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_to_py_Py_intptr_t((__pyx_v_input->dimensions[0])); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 182; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyNumber_Divide(__pyx_t_1, __pyx_t_2); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 182; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_4 = __Pyx_PyInt_AsInt(__pyx_t_3); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 182; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_data.nframes = __pyx_t_4;

  /* "macosx_backend.pyx":183
 *         data.idata = <float*>input.data
 *         data.nframes = input.size / input.shape[0]
 *         if self.nchannels == 1:             # <<<<<<<<<<<<<<
 *             data.fake_stereo = 1
 *         else:
 */
  __pyx_t_5 = ((__pyx_v_self->nchannels == 1) != 0);
  if (__pyx_t_5) {

    /* "macosx_backend.pyx":184
 *         data.nframes = input.size / input.shape[0]
 *         if self.nchannels == 1:
 *             data.fake_stereo = 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    __pyx_t_3 = PyObject_Call(__pyx_builtin_RuntimeError, ((PyObject *)__pyx_k_tuple_15), NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 192; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __pyx_t_3 = PyObject_Call(__pyx_builtin_RuntimeError, ((PyObject *)__pyx_k_tuple_17), NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 196; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  while (1) {
    __pyx_t_5 = ((__pyx_v_data.remaining == 1) != 0);
    if (!__pyx_t_5) break;

    /* "macosx_backend.pyx":199
 * 
 *         while (data.remaining == 1):
 *             st = cpython.PyErr_CheckSignals()             # <<<<<<<<<<<<<<
 *             if st != 0:
 *                     gotsig = 1
 */
    __pyx_t_4 = PyErr_CheckSignals(); if (unlikely(__pyx_t_4 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 199; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __pyx_v_st = __pyx_t_4;

    /* "macosx_backend.pyx":200
 *         while (data.remaining == 1):
 *             st = cpython.PyErr_CheckSignals()
 *             if st != 0:             # <<<<<<<<<<<<<<
 *                     gotsig = 1
 *                     break
 */
    __pyx_t_5 = ((__pyx_v_st != 0) != 0);
    if (__pyx_t_5) {

      /* "macosx_backend.pyx":201
 *             st = cpython.PyErr_CheckSignals()
 *             if st != 0:
 *                     gotsig = 1             # <<<<<<<<<<<<<<
 *                     break
 ...
 *         #if self.proc_set:
 */
    if (__Pyx_PrintOne(0, ((PyObject *)__pyx_kp_s_18)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 209; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    goto __pyx_L9;
  }
  __pyx_L9:;

  /* "macosx_backend.pyx":212
 * 
 *         #if self.proc_set:
 ...
 *         if gotsig:
 */
    if (__Pyx_PrintOne(0, ((PyObject *)__pyx_kp_s_19)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 214; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    goto __pyx_L10;
  }
  __pyx_L10:;

  /* "macosx_backend.pyx":216
 *             print "AudioDeviceRemoveIO failed"
 * 
 *         if gotsig:             # <<<<<<<<<<<<<<
 *             return -1
 * 
 */
  __pyx_t_5 = (__pyx_v_gotsig != 0);
  if (__pyx_t_5) {

    /* "macosx_backend.pyx":217
 * 
 *         if gotsig:
 *             return -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_AddTraceback("macosx_backend.CoreAudioDevice._play", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyObject *__pyx_tp_new_14macosx_backend_CoreAudioDevice(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
...
static PyMethodDef __pyx_methods_14macosx_backend_CoreAudioDevice[] = {
  {__Pyx_NAMESTR("play"), (PyCFunction)__pyx_pw_14macosx_backend_15CoreAudioDevice_3play, METH_O, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_14macosx_backend_CoreAudioDevice = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("macosx_backend.CoreAudioDevice"), /*tp_name*/
  ...
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  __pyx_pw_14macosx_backend_15CoreAudioDevice_1__init__, /*tp_init*/
  0, /*tp_alloc*/
...
static int __Pyx_InitCachedBuiltins(void) {
  ...
  __pyx_builtin_RuntimeError = __Pyx_GetBuiltinName(__pyx_n_s__RuntimeError); if (!__pyx_builtin_RuntimeError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 125; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_builtin_NotImplementedError = __Pyx_GetBuiltinName(__pyx_n_s__NotImplementedError); if (!__pyx_builtin_NotImplementedError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  return 0;
  __pyx_L1_error:;
  return -1;
}
 ...
 *         # Get default output stream format
 */
  __pyx_k_tuple_2 = PyTuple_Pack(1, ((PyObject *)__pyx_kp_s_1)); if (unlikely(!__pyx_k_tuple_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 125; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         # Set sampling rate and number of channels
 */
  __pyx_k_tuple_4 = PyTuple_Pack(1, ((PyObject *)__pyx_kp_s_3)); if (unlikely(!__pyx_k_tuple_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         if not input.dtype == np.float64:
 */
  __pyx_k_tuple_10 = PyTuple_Pack(1, ((PyObject *)__pyx_kp_s_9)); if (unlikely(!__pyx_k_tuple_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 160; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         nc = input.shape[0]
 */
  __pyx_k_tuple_12 = PyTuple_Pack(1, ((PyObject *)__pyx_kp_s_11)); if (unlikely(!__pyx_k_tuple_12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         st = AudioDeviceStart (self.dev, self.callback)
 */
  __pyx_k_tuple_15 = PyTuple_Pack(1, ((PyObject *)__pyx_kp_s_14)); if (unlikely(!__pyx_k_tuple_15)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 192; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         while (data.remaining == 1):
 */
  __pyx_k_tuple_17 = PyTuple_Pack(1, ((PyObject *)__pyx_kp_s_16)); if (unlikely(!__pyx_k_tuple_17)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 196; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_macosx_backend(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("macosx_backend"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "macosx_backend")) {
      if (unlikely(PyDict_SetItemString(modules, "macosx_backend", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  ...
  #endif
  if (__pyx_module_is_main_macosx_backend) {
  ...
  __pyx_vtable_14macosx_backend_CoreAudioDevice._play = (int (*)(struct __pyx_obj_14macosx_backend_CoreAudioDevice *, PyArrayObject *))__pyx_f_14macosx_backend_15CoreAudioDevice__play;
  ...
  if (__Pyx_SetAttrString(__pyx_m, "CoreAudioDevice", (PyObject *)&__pyx_type_14macosx_backend_CoreAudioDevice) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s__np, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 38; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "macosx_backend.pyx":1
 * #             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init macosx_backend", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init macosx_backend");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
